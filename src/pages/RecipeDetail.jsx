    ...
    <div className='w-full '>
      ...
      <div className='w-full h-[100vh]' >
        ...
        <div className='absolute w-full h-full bg-gradient-to-t from-black to-transparent top-0 z-8 flex flex-col items-center justify-center pt-40 2xl:pt-20 px-4 '>
          <h1 className='text-white text-4xl md:text-5xl font-bold text-center'>{recipe?.label}</h1>
      ...
      <div className='w-full px-4 lg:px-20 pt-5'>
        ...
        <div className='flex gap-10 items-center justify-center px-4'>
          ...
          <div className='flex flex-col justify-center'>
            <Link to="/recipes" className='w-full md:w-[220px]'>
        ...
        {/* <div className='flex flex-col justify-center'>
            <span className='text-white text-center border border-gray-500 py-1.5 rounded-full mb-2'>
            <Link to="/recipe">
              <button>Back To Find the Recipes</button>
              </Link>
            </span>
          </div> */}
